 ...
 const Title =()=> {
  ...
  <div className="title_outer">
    <div className='title_inner'>
        ...
        <div className='button'><div><p>Email</p></div></div>
        <div className='button'><div><p>Github</p></div></div>
        <div className='button'><div><p>Linkedin</p></div></div>
        </div>
    </div>
  </div>
  );
