  ...
  <div className="title_outer">
    <div className='title_inner'>
        ...
        <div className='description_box'>
            <p>I am a self taught <span>Front-end</span>  and talanted <span>Google</span> user, based in Riga, Latvia. I enjoy building <span>projects</span> that live on the internet.</p>
        </div>
